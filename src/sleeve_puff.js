export default function (part) {
    ...
    points.midTriangleLeft = points.grainbottomtemp
      .translate(-options.puffmidtrianglewidth/2, options.pufflength)
    points.midTriangleRight = points.midTriangleLeft.shift(0, options.puffmidtrianglewidth)
    points.leftTriangleTop = points.wristCircumferenceleft
      .shift(0, measurements.wristCircumference / 8)
    points.leftTriangleR = points.leftTriangleTop.shift(-90, options.pufflength)
    points.leftTriangleL = points.leftTriangleR.shift(180, options.puffsidetrianglewidth)
    points.rightTriangleTop = points.wristCircumferenceright
      .shift(180, measurements.wristCircumference / 8)
    points.rightTriangleL = points.rightTriangleTop.shift(-90, options.pufflength)
    points.rightTriangleR = points.rightTriangleL.shift(0, options.puffsidetrianglewidth)
    let puffWidth = measurements.wristCircumference + 2*options.puffsidetrianglewidth + options.puffmidtrianglewidth
    points.puffLeft = points.grainbottomtemp
      .translate(-puffWidth/2, options.pufflength)
    points.puffRight = points.puffLeft.shift(0, puffWidth)
    ...
    paths.puff = new Path()
      .move(points.wristCircumferenceleft)
      .line(points.puffLeft)
      .line(points.puffRight)
      .line(points.wristCircumferenceright)
    paths.midTriangle = new Path()
      .move(points.midTriangleLeft)
      .line(points.grainbottomtemp)
      .line(points.midTriangleRight)
    paths.leftTriangle = new Path()
      .move(points.leftTriangleL)
      .line(points.leftTriangleTop)
      .line(points.leftTriangleR)
    paths.rightTriangle = new Path()
      .move(points.rightTriangleL)
      .line(points.rightTriangleTop)
      .line(points.rightTriangleR)

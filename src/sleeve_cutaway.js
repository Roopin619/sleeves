export default function (part) {
    ...
    points.wristBandTopRight = points.wristCircumferenceright.shift(90, options.bandlength)
    points.wristBandTopLeft = points.wristBandTopRight.flipX()
    ...
    points.triangleTop = points.grainbottomtemp
      .shift(90, options.cutawaytriangleheight + options.bandlength)
    points.triangleLeft = points.triangleTop
      .translate(-options.cutawaytrianglewidth/2, options.cutawaytriangleheight)
    points.triangleRight = points.triangleLeft.shift(0, options.cutawaytrianglewidth)
